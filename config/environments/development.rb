...
Rails.application.configure do
  ...
  # Uncomment when trying to debug tests
  ...
  config.log_tags = [:request_id, :remote_ip, :method, :path, :format]
  ...
  # Try and avoid error: [ActionDispatch::HostAuthorization::DefaultResponseApp] Blocked host: wca_registration_handler
  config.hosts.clear
