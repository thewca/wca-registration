...
RSpec.shared_context 'Registrations' do
  before do
    get_registration('CubingZANationalChampionship2023-158816')
    get_registration('CubingZANationalChampionship2023-158817')
    get_registration('')
    get_registration('CubingZANationalChampionship2023-158818')
  end
end
